...
export async function mockRequest<T>(endpoint: string, options: RequestInit = {}): Promise<T> {
  ...
  if (path === '/logs/files' && method === 'GET') {
    return {
      ...
      files: [
        {
          name: 'crash_2026-02-22_120000.log',
          path: '/profiles/crash_2026-02-22_120000.log',
          size_bytes: 1024 * 64,
          size_human: '64 KB',
          modified: '2026-02-22T12:00:00',
          category: 'crash',
        },
        {
          name: 'DayZServer_x64_2026-02-22_100000.RPT',
          path: '/profiles/DayZServer_x64_2026-02-22_100000.RPT',
        ...
        {
          name: 'DayZServer_x64_2026-02-21_080000.RPT',
          path: '/profiles/DayZServer_x64_2026-02-21_080000.RPT',
          size_bytes: 1024 * 1024 * 5,
          size_human: '5 MB',
          modified: '2026-02-21T18:00:00',
          category: 'rpt',
        },
        {
          name: 'script_2026-02-22_100000.log',
          path: '/profiles/script_2026-02-22_100000.log',
          size_bytes: 1024 * 256,
          size_human: '256 KB',
          modified: '2026-02-22T10:30:00',
          category: 'script',
        ...
        {
          name: 'script_2026-02-21_080000.log',
          path: '/profiles/script_2026-02-21_080000.log',
          size_bytes: 1024 * 180,
          size_human: '180 KB',
          modified: '2026-02-21T18:00:00',
          category: 'script',
        ...
        {
          name: 'error.log',
          path: '/profiles/error.log',
          size_bytes: 1024 * 12,
          size_human: '12 KB',
          modified: '2026-02-22T09:00:00',
          category: 'error',
        },
        {
